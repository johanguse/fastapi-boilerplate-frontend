      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            {t('aiAnalytics.settingsDescription', 'Configure AI analytics preferences and limits')}
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              {t('aiAnalytics.queryDescription', 'Configure query execution and validation')}
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              <Select 
                ...
                onValueChange={(value) => handleSettingChange('default_chart_type', value)}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
            ...
            <div className="space-y-2">
              ...
              <Select 
                ...
                onValueChange={(value) => handleSettingChange('max_query_complexity', parseInt(value))}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => handleSettingChange('query_timeout', parseInt(e.target.value))}
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => handleSettingChange('max_rows_per_query', parseInt(e.target.value))}
              />
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              {t('aiAnalytics.featureDescription', 'Enable or disable analytics features')}
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                ...
                <p className="text-xs text-muted-foreground">
                  {t('aiAnalytics.autoExecuteDescription', 'Automatically execute queries when typed')}
                </p>
              </div>
              <Switch
                id="auto-execute"
                checked={settings.auto_execute_queries}
                onCheckedChange={(checked) => handleSettingChange('auto_execute_queries', checked)}
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                <Label htmlFor="query-validation">
                  {t('aiAnalytics.enableQueryValidation', 'Enable Query Validation')}
                </Label>
                <p className="text-xs text-muted-foreground">
                  {t('aiAnalytics.validationDescription', 'Validate queries before execution')}
                </p>
              </div>
              <Switch
                id="query-validation"
                checked={settings.enable_query_validation}
                onCheckedChange={(checked) => handleSettingChange('enable_query_validation', checked)}
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                <Label htmlFor="sql-explanation">
                  {t('aiAnalytics.enableSQLExplanation', 'Enable SQL Explanation')}
                </Label>
                <p className="text-xs text-muted-foreground">
                  {t('aiAnalytics.explanationDescription', 'Show explanations for generated SQL')}
                </p>
              </div>
              <Switch
                id="sql-explanation"
                checked={settings.enable_sql_explanation}
                onCheckedChange={(checked) => handleSettingChange('enable_sql_explanation', checked)}
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                ...
                <p className="text-xs text-muted-foreground">
                  {t('aiAnalytics.cachingDescription', 'Cache query results for faster access')}
                </p>
              </div>
              <Switch
                id="caching"
                checked={settings.enable_caching}
                onCheckedChange={(checked) => handleSettingChange('enable_caching', checked)}
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                ...
                <p className="text-xs text-muted-foreground">
                  {t('aiAnalytics.privacyDescription', 'Protect sensitive data in queries')}
                </p>
              </div>
              <Switch
                id="data-privacy"
                checked={settings.enable_data_privacy}
                onCheckedChange={(checked) => handleSettingChange('enable_data_privacy', checked)}
              />
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              {t('aiAnalytics.usageDescription', 'Current usage and limits for analytics features')}
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            {usageStats ? (
              <>
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    <span className="text-sm font-medium">{t('aiAnalytics.totalQueries', 'Total Queries')}</span>
                    <span className="text-sm">{usageStats.total_queries}</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-sm font-medium">{t('aiAnalytics.chartsGenerated', 'Charts Generated')}</span>
                    <span className="text-sm">{usageStats.charts_generated}</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-sm font-medium">{t('aiAnalytics.totalTokens', 'Total Tokens')}</span>
                    <span className="text-sm">{usageStats.total_tokens.toLocaleString()}</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-sm font-medium">{t('aiAnalytics.totalCost', 'Total Cost')}</span>
                    <span className="text-sm">${usageStats.total_cost.toFixed(4)}</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-sm font-medium">{t('aiAnalytics.avgExecutionTime', 'Avg Execution Time')}</span>
                    <span className="text-sm">{usageStats.avg_execution_time}ms</span>
                  </div>
                </div>
