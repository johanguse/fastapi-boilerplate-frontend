...
export function ImageUpload({
  ...
  return (
    <div className={cn("space-y-4", className)}>
      <div
        className={cn(
          "relative flex items-center justify-center overflow-hidden border-2 border-dashed border-muted-foreground/25 bg-muted/50 transition-colors hover:border-muted-foreground/50 hover:bg-muted/80",
          sizeClasses[size],
          shapeClass,
