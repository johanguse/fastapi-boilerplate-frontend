...
├── i18n/
│   ├── locales/                # Translation files (import-based)
│   │   ├── en-US/
...
│   └── resources.d.ts          # Generated resource definitions
└── components/
...
### Migration Steps
1. **Move translation files**: `public/locales/` → `src/i18n/locales/`
